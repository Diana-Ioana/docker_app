...
public class DiseaseViewDTO {
    ...
    public DiseaseViewDTO() {}

    public DiseaseViewDTO(int idDisease, String diseaseName, Date diseaseDiagnosticDate, String diseaseSimptoms, MedicalRecord medicalRecord_idMedicalRecord) {
